...
const Hero = () => {
  ...
  return (
    ...
    className='w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container'>
      <div className='relative xl:w-2/5 flex flex-col max-xl:padding-x pt-28'>
      ...
      <div className='relative flex-1 flex xl:min-h-screen max-xl:py-40 bg-hero bg-cover  bg-primary justify-center items-center'>
        
        <img src={bigShoeImg} alt="Shoe collection" width={610} height={500}
        className='object-contain z-10 relative p-5' />

        <div className='flex sm:gap-6 gap-4 absolute -bottom-[7%] max-sm:px-6'>
          {shoes.map((shoe)=>(
            <div>
              <ShoeCard
